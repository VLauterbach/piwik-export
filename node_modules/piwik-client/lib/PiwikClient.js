...
PiwikClient = (function() {
  function PiwikClient(baseURL, token, clientCert) {
    var url, _ref, _ref1;
    ...
    if (clientCert) {
      this.settings.clientCert = clientCert.cert;
      this.settings.clientKey = clientCert.key;
      this.settings.strictSSL = clientCert.strictSSL;
    }
  ...
  PiwikClient.prototype.api = function(vars, cb) {
    ...
    return this.http.get({
      ...
      key: this.settings.cert,
      cert: this.settings.key,
